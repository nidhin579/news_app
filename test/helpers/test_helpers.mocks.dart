...
// in news_app_nidhin/test/helpers/test_helpers.dart.
...
import 'package:news_app_nidhin/enums/news_category.dart' as _i9;
...
class MockNewsService extends _i1.Mock implements _i8.NewsService {
  ...
  @override
  bool get loadedAllArticles => (super.noSuchMethod(
        Invocation.getter(#loadedAllArticles),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);

  @override
  set loadedAllArticles(bool? _loadedAllArticles) => super.noSuchMethod(
        Invocation.setter(
          #loadedAllArticles,
          _loadedAllArticles,
        ),
  ...
  @override
  set currentCategory(_i9.NewsCategory? _currentCategory) => super.noSuchMethod(
        Invocation.setter(
          #currentCategory,
          _currentCategory,
        ),
  ...
  @override
  void switchCategory(_i9.NewsCategory? category) => super.noSuchMethod(
        Invocation.method(
          #switchCategory,
          [category],
        ),
  ...
  _i6.Future<List<_i10.Article>> fetchNews({bool? isNew = false}) =>
      (super.noSuchMethod(
        ...
        returnValueForMissingStub:
            _i6.Future<List<_i10.Article>>.value(<_i10.Article>[]),
      ) as _i6.Future<List<_i10.Article>>);
}
