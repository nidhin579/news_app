...
import 'package:news_app_nidhin/models/article.dart' as _i6;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.NewsDetailView: (data) {
      final args = data.getArgs<NewsDetailViewArguments>(nullOk: false);
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i4.NewsDetailView(key: args.key, article: args.article),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i7.NavigationService {
  ...
  Future<dynamic> navigateToNewsDetailView({
    ...
    return navigateTo<dynamic>(Routes.newsDetailView,
        arguments: NewsDetailViewArguments(key: key, article: article),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
